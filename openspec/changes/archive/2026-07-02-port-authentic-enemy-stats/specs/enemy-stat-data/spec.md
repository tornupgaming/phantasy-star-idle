...
Enemies instantiated in a run SHALL take their combat stats (HP, ATP, DFP, ATA, EVP, LCK) and their EXP and meseta awards from the dataset row matching the enemy's type and the run's difficulty. Difficulty-based stat multipliers SHALL NOT be applied to dataset-backed stats.
