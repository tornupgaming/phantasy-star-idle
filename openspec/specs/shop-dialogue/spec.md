# shop-dialogue Specification

## Purpose
Give hub locations a voice through a PSO-style dialogue window: pane greetings, typewriter reveal, reactive shopkeeper lines, and item flavor text. (TBD: refine as the capability evolves.)
