# weapon-avoidance Specification

## Purpose

Give each authentic weapon kind an avoidance percentage reflecting its PSO effective range, and let the virtual player sidestep incoming enemy attacks based on the equipped weapon's kind — making the melee-vs-ranged choice a survivability tradeoff without altering the authentic combat formulas.
