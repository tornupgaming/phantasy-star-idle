# item-iconography Specification

## Purpose
Make item lists legible at PSO density: kind glyphs on every row, semantic name coloring with an equipped marker, and compact rows with aligned trailing values. (TBD: refine as the capability evolves.)
