...
## Purpose
Define per-character progression: class-and-level-derived base stats from the ported PSO Blue Burst tables, experience accumulation, and leveling from run XP. (TBD: refine as the capability evolves.)
