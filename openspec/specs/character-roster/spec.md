...
## Purpose
Manage the account's roster of characters: creation (name, class, section ID), selection, deletion, and migration of legacy single-character saves. (TBD: refine as the capability evolves.)
