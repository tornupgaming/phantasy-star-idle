# item-pricing Specification

## Purpose
Price every item with the authentic PSO formulas (ported price_for_item) and the flat ÷8 sell-back rule, replacing all placeholder pricing.
